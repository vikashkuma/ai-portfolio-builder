...
const client = new InferenceClient("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");
...
export const generateContent = async (section: string, input: string): Promise<string> => {
  ...
  const prompts: Record<string, (input: string) => string> = {
    about: (input) => `Generate a professional bio section for the following user. Output only the bio section content, with no explanations, <think> blocks, or extra formatting.\n${input}`,
    experience: (input) => `Generate a concise experience/role/achievement section for a portfolio. Output only the experience section content, with no explanations, <think> blocks, or extra formatting.\n${input}`,
    education: (input) => `Generate an education section for a portfolio. Output only the education section content, with no explanations, <think> blocks, or extra formatting.\n${input}`,
    skills: (input) => `Generate a skills section for a portfolio. Output only the skills section content, with no explanations, <think> blocks, or extra formatting.\n${input}`,
    awards: (input) => `Generate an awards/recognition section for a portfolio. Output only the awards section content, with no explanations, <think> blocks, or extra formatting.\n${input}`,
    testimonials: (input) => `Generate a testimonial for a portfolio. Output only the testimonial content, with no explanations, <think> blocks, or extra formatting.\n${input}`,
    contact: (input) => `Generate a contact section for a portfolio. Output only the contact section content, with no explanations, <think> blocks, or extra formatting.\n${input}`,
    preview: (input) => `Generate a summary preview for a portfolio. Output only the preview content, with no explanations, <think> blocks, or extra formatting.\n${input}`,
  };
